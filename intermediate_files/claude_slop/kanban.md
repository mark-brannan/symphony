...
- [ ] Land [PR #34](https://github.com/mark-brannan/symphony/pull/34) (host files; your three comments applied 2026-09-01), then walk the [PR #25](https://github.com/mark-brannan/symphony/pull/25) dashboards live — setup and script in [pr25-demo-walkthrough.md](pr25-demo-walkthrough.md). [#33](https://github.com/mark-brannan/symphony/pull/33) needs rework, scope not yet stated. [#28](https://github.com/mark-brannan/symphony/pull/28) and [#29](https://github.com/mark-brannan/symphony/pull/29) are placeholders, not for landing. #31 closed as superseded.
