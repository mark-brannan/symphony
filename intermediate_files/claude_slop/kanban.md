...
### Repo & tooling
- [ ] **Review the 12 V nav-light controller design** — [#64](https://github.com/mark-brannan/symphony/pull/64). Two answers needed before it can be built: is CH1 a steaming light or a masthead tricolour (circuit identical, mode table differs), and are the fixtures incandescent or LED (decides whether the inrush line in the MOSFET spec envelope binds).
