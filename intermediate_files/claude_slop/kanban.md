...
- [ ] [Bench-test the containerized pypilot on the HALOS Pi](kanban-detail.md#bench-test-containerized-pypilot-on-halos) — blocked: PR #37 not yet merged. Run the exact prompt at the link, verbatim, once unblocked.
