...
On the HALPI2: it is sold out as of 2026-08-13, with all memory and SSD variants unavailable, because Compute Module 5 supply is short worldwide. The vendor's own notice says configurations go out of stock with little notice, which cuts both ways — check the shop rather than trusting this line, and if a suitable variant is in stock, that is the moment to buy.
