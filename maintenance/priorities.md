...
- Verify Grafana SSO end to end. Its OAuth config is live and the service is back up, but the browser login was never checked — `grafana-server` was stopped during the 2026-08-11 SignalK work.
